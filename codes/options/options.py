...
def check_resume(opt, resume_iter):
    ...
    if opt['path']['resume_state']:
        if opt['path'].get('pretrain_model_G', None) is not None or opt['path'].get(
                'pretrain_model_A', None) is not None:
        ...
        opt['path']['pretrain_model_S'] = osp.join(opt['path']['models'],
                                                   '{}_S.pth'.format(resume_iter))
        logger.info('Set [pretrain_model_S] to ' + opt['path']['pretrain_model_S'])
